...
function antwort4(antwort) {
  if (antwort == "Totengräber") {
    ...
    output("Ich verstehe dich nicht! Gebe bitte eine der folgenden Optionen ein: Seemann, Totengräber, Geistlicher, Fahrender Händler.", antwort4);
  }  
}
...
function antwort5(antwort) {
  if (antwort == "Maske tragen") {
    ...
    output("Ich verstehe dich nicht. Bitte entscheide dich für eine der folgenden Schutzmaßnahmen: Maske tragen, Absatnd halten, Tiere streicheln, Gewand nicht wechseln.", antwort5);
  }  
}
...
function antwort6(antwort) {
  if (antwort == "Wohnheim") {
    ...
    output("Das scheint mir keine der möglichen Optionen zu sein. Entscheide dich bitte zwischen Wohnheim, Krankenhaus, Kirche oder Marktplatz.", antwort6);
  }  
}
...
function antwort7(antwort) {
  if (antwort == "zurücklassen") {
    ...
    output("Was genau möchtest du mir deinem Familienmitglied machen? Aderlass vornehmen, zurücklasse, pflegen oder möchtest du beten?", antwort7);
  }  
}
...
function antwort8(antwort) {
  if (antwort == "Quarantäne") {
    ...
    output("Es scheint so, als wäre das keine Option. Versuch es doch einmal mit Quarantäne, Bußprozession oder Ausräuchern.", antwort8);
  }  
}
...
function antwort9(antwort) {
  if (antwort == "Keines") {
    ...
    output("Auf dem örtlichen Markt kannst du leider nur eines der ganannten Tiere erwerben. Wenn dich keines davon anspricht, dann wähle Keines. Ansonsten nimm eine Katze, einen Hund oder eine Ratte. ", antwort9);
  }  
}
...
function antwort10(antwort) {
  if (antwort == "Ja") {
    ...
    output("Ich verstehe dich leider nicht. Bist du bereit? Ja oder Nein?", antwort10);
  }  
}
...
function antwort11(antwort) {
  if (antwort <= 13) {
    ...
    output("Ich habe das nicht richtig verstanden. Kannst du mir erneut dein Alter nennen.", antwort11);
  } 
}
...
function antwort15(antwort) {
  if (antwort == "zurücklassen") {
    ...
    output("Was genau möchtest du mir deinem Familienmitglied machen? Aderlass vornehmen, zurücklasse, pflegen oder möchtest du beten?", antwort15);
  }  
}
...
function antwort17(antwort) {
  if (antwort == "Keines") {
    ...
    output("Auf dem örtlichen Markt kannst du leider nur eines der ganannten Tiere erwerben. Wenn dich keines davon anspricht, dann wähle Keines. Ansonsten nimm eine Katze, einen Hund oder eine Ratte. ", antwort17);
  }  
}
...
function frage20() {
  ...
  function antwort20(antwort) {
    if (antwort == "Totengräber") {
      ...
      output("Ich verstehe dich nicht! Gebe bitte eine der folgenden Optionen ein: Seemann, Totengräber, Geistlicher, Fahrender Händler.", antwort20);
    }  
  }
  ...
  function antwort21(antwort) {
    if (antwort == "Maske tragen") {
      ...
      output("Ich verstehe dich nicht. Bitte entscheide dich für eine der folgenden Schutzmaßnahmen: Maske tragen, Absatnd halten, Tiere streicheln, Gewand nicht wechseln.", antwort21);
    }  
  }
  ...
  function antwort22(antwort) {
    if (antwort == "Wohnheim") {
      ...
      output("Das scheint mir keine der möglichen Optionen zu sein. Entscheide dich bitte zwischen Wohnheim, Krankenhaus, Kirche oder Marktplatz.", antwort22);
    }
  }
  ...
  function antwort23(antwort) {
    if (antwort == "zurücklassen") {
      ...
      output("Was genau möchtest du mir deinem Familienmitglied machen? Aderlass vornehmen, zurücklasse, pflegen oder möchtest du beten?", antwort23);
    }  
  }
  ...
  function antwort25(antwort) {
    if (antwort == "Keines") {
      ...
      output("Auf dem örtlichen Markt kannst du leider nur eines der ganannten Tiere erwerben. Wenn dich keines davon anspricht, dann wähle Keines. Ansonsten nimm eine Katze, einen Hund oder eine Ratte. ", antwort25);
    }  
  }
  ...
  function antwort26(antwort) {
    if (antwort == "Totengräber") {
      ...
      output("Ich verstehe dich nicht! Gebe bitte eine der folgenden Optionen ein: Seemann, Totengräber, Geistlicher, Fahrender Händler.", antwort26);
    }  
  }
